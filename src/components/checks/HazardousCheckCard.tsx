...
import { upsertHazardousCheckLog } from '@/lib/api/hazardousCheckLog'
...
export function HazardousCheckCard({
  date,
  initialItems,
  initialConfirmer,
  initialAdminSign,
  ...
  const save = async () => {
    ...
    try {
      ...
      console.error('[HazardousCheckCard] save error', e)
      setSaveStatus('idle')
    }
  }
    ...
    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-5 space-y-5">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2 flex-wrap">
          <h2 className="font-bold text-slate-700">🔥 危険物施設点検表</h2>
